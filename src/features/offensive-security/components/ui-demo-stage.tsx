...
/**
 * Practice Range của Offensive Security — key là slug của OffensiveSecurityCollection.
 *
 * ⚠️ Các lab cũ (Render Visualizer, Memo Profiler, Cache Timeline…) là lab
 * học React, không được tính là curriculum. Mỗi collection có bãi tập thực chiến
